...
BaseScreenSheet::BaseScreenSheet(SDL2pp::Renderer& renderer): renderer(renderer), texture() {}


void BaseScreenSheet::load_sprite() {
    SDL2pp::Surface surface(screen_path);
...
Sprite BaseScreenSheet::get_screen_sprite() {
