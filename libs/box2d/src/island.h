...
// Use bit array to emit start/stop touching events in defined order, per thread. Try using contact
// index, assuming contacts are created in a deterministic order. bit-wise OR together bit arrays
// and issue changes:
// - start touching: merge islands - temporary linked list - mark root island dirty - wake all -
// largest island is root
