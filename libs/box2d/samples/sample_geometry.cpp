...
public:
    enum { e_count = B2_MAX_POLYGON_VERTICES };

    explicit ConvexHull(SampleContext* context): Sample(context) {
    ...
    void Step() override {
        ...
        for (int32_t i = 0; i < m_count; ++i) {
            ...
            DrawWorldString(m_draw, m_camera, b2Add(m_points[i], {0.1f, 0.1f}), b2_colorWhite, "%d",
                            i);
        }
    ...
    static Sample* Create(SampleContext* context) { return new ConvexHull(context); }
