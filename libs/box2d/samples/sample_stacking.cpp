...
public:
    explicit SingleBox(SampleContext* context): Sample(context) {
    ...
    static Sample* Create(SampleContext* context) { return new SingleBox(context); }
...
public:
    explicit TiltedStack(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new TiltedStack(context); }
...
public:
    enum { e_maxColumns = 10, e_maxRows = 15, e_maxBullets = 8 };

    enum ShapeType { e_circleShape = 0, e_boxShape };

    explicit VerticalStack(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    void UpdateGui() override {
        ...
        if (ImGui::Button("Fire Bullets") ||
            glfwGetKey(m_context->window, GLFW_KEY_B) == GLFW_PRESS) {
            DestroyBullets();
            FireBullets();
        }
    ...
    static Sample* Create(SampleContext* context) { return new VerticalStack(context); }
...
static int sampleVerticalStack =
        RegisterSample("Stacking", "Vertical Stack", VerticalStack::Create);
...
public:
    ...
    explicit CircleStack(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new CircleStack(context); }
...
public:
    ...
    explicit CapsuleStack(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
            m_context->camera.center = {0.0f, 5.0f};
            m_context->camera.zoom = 6.0f;
        }
    ...
    static Sample* Create(SampleContext* context) { return new CapsuleStack(context); }
};
...
public:
    explicit Cliff(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new Cliff(context); }
...
public:
    explicit Arch(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new Arch(context); }
};
...
public:
    explicit DoubleDomino(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new DoubleDomino(context); }
};
...
public:
    explicit Confined(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new Confined(context); }
...
public:
    explicit CardHouse(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new CardHouse(context); }
};
