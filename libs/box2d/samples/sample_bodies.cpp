...
public:
    ...
    static Sample* Create(SampleContext* context) { return new BodyType(context); }
...
float FrictionCallback(float, uint64_t, float, uint64_t) { return 0.1f; }

float RestitutionCallback(float, uint64_t, float, uint64_t) { return 1.0f; }

class Weeble: public Sample {
public:
    explicit Weeble(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new Weeble(context); }
...
public:
    explicit Sleep(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new Sleep(context); }
...
public:
    explicit BadBody(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
            m_context->camera.center = {2.3f, 10.0f};
            m_context->camera.zoom = 25.0f * 0.5f;
        }
    ...
    static Sample* Create(SampleContext* context) { return new BadBody(context); }
...
public:
    explicit Pivot(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
            m_context->camera.center = {0.8f, 6.4f};
            m_context->camera.zoom = 25.0f * 0.4f;
        }
    ...
    static Sample* Create(SampleContext* context) { return new Pivot(context); }
...
public:
    explicit Kinematic(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new Kinematic(context); }
...
public:
    explicit MixedLocks(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new MixedLocks(context); }
};
...
public:
    explicit SetVelocity(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
            m_context->camera.center = {0.0f, 2.5f};
            m_context->camera.zoom = 3.5f;
        }
    ...
    static Sample* Create(SampleContext* context) { return new SetVelocity(context); }
...
public:
    explicit WakeTouching(SampleContext* context): Sample(context) {
        if (m_context->restart == false) {
    ...
    static Sample* Create(SampleContext* context) { return new WakeTouching(context); }
