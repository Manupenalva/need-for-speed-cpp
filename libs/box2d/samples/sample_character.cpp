...
enum PogoShape { PogoPoint, PogoCircle, PogoSegment };
...
public:
    explicit Mover(SampleContext* context): Sample(context) {
        ...
        b2BodyId groundId1;
        {
            ...
            const char* path = "M 2.6458333,201.08333 H 293.68751 v -47.625 h -2.64584 l "
                               "-10.58333,7.9375 -13.22916,7.9375 -13.24648,5.29167 "
                               "-31.73269,7.9375 -21.16667,2.64583 -23.8125,10.58333 H 142.875 v "
                               "-5.29167 h -5.29166 v 5.29167 H 119.0625 v "
                               "-2.64583 h -2.64583 v -2.64584 h -2.64584 v -2.64583 H 111.125 v "
                               "-2.64583 H 84.666668 v -2.64583 h -5.291666 v "
                               "-2.64584 h -5.291667 v -2.64583 H 68.791668 V 174.625 h -5.291666 "
                               "v -2.64584 H 52.916669 L 39.6875,177.27083 H "
                               "34.395833 L 23.8125,185.20833 H 15.875 L 5.2916669,187.85416 V "
                               "153.45833 H 2.6458333 v 47.625";
        ...
        b2BodyId groundId2;
        {
            ...
            const char* path = "M 2.6458333,201.08333 H 293.68751 l 0,-23.8125 h -23.8125 l "
                               "21.16667,21.16667 h -23.8125 l -39.68751,-13.22917 "
                               "-26.45833,7.9375 -23.8125,2.64583 h -13.22917 l -0.0575,2.64584 h "
                               "-5.29166 v -2.64583 l -7.86855,-1e-5 "
                               "-0.0114,-2.64583 h -2.64583 l -2.64583,2.64584 h -7.9375 l "
                               "-2.64584,2.64583 -2.58891,-2.64584 h -13.28609 v "
                               "-2.64583 h -2.64583 v -2.64584 l -5.29167,1e-5 v -2.64583 h "
                               "-2.64583 v -2.64583 l -5.29167,-1e-5 v -2.64583 h "
                               "-2.64583 v -2.64584 h -5.291667 v -2.64583 H 92.60417 V 174.625 h "
                               "-5.291667 v -2.64584 l -34.395835,1e-5 "
                               "-7.9375,-2.64584 -7.9375,-2.64583 -5.291667,-5.29167 H 21.166667 L "
                               "13.229167,158.75 5.2916668,153.45833 H "
    ...
    void SolveMove(float timeStep, float throttle) {
        ...
        if (castResult.hit == false) {
            ...
            m_pogoVelocity = b2SpringDamper(m_pogoHertz, m_pogoDampingRatio, offset, m_pogoVelocity,
                                            timeStep);
        ...
        b2Vec2 target = m_transform.p + timeStep * m_velocity +
                        timeStep * m_pogoVelocity * b2Vec2{0.0f, 1.0f};
        ...
        for (int iteration = 0; iteration < 5; ++iteration) {
            ...
            b2PlaneSolverResult result =
                    b2SolvePlanes(target - m_transform.p, m_planes, m_planeCount);
    ...
    void Keyboard(int key) override {
        if (key == 'K') {
            b2Vec2 point = b2TransformPoint(m_transform,
                                            {0.0f, m_capsule.center1.y - 3.0f * m_capsule.radius});
    ...
    static Sample* Create(SampleContext* context) { return new Mover(context); }
